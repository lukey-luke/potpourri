...
"""
above test fails, because eval_response is 'N', we're getting a bad response
Intentionally causing CI to fail in order to illustrate how this would be done in a production workflow

test_release_evals.py:63: AssertionError
----------------------------- Captured stdout call -----------------------------
There are lots of interesting facts. Tell me more about what you'd like to know
------------ generated xml file: /home/circleci/project/results.xml ------------
=========================== short test summary info ============================
FAILED test_release_evals.py::test_model_graded_eval_should_fail - AssertionError: expected failure, asserted the response should be 'Y',     got back 'N'
assert 'N' == 'Y'
  - Y
  + N
========================= 1 failed, 1 passed in 3.62s ==========================
"""
